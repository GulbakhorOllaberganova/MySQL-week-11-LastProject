...
//accepts user input from console then performs CRUD operations on the project tables.
...
//gets a user selection prints the operations and repeats until user's request of termination.
...
//Gathers user input then call the project service to create the row.
